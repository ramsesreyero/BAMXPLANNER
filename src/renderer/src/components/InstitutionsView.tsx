          ...
          <div className="bg-white rounded-[2rem] shadow-2xl border border-white/20 w-full max-w-3xl max-h-[92vh] overflow-hidden animate-in zoom-in-95 duration-300 flex flex-col">
            <div className="p-10 border-b border-slate-100 relative">
              ...
              <button
                ...
                type="button"
                className="absolute top-8 right-8 z-[100] text-slate-700 hover:text-slate-955 transition-all w-10 h-10 flex items-center justify-center hover:bg-slate-200/60 active:scale-95 rounded-full font-bold text-xl cursor-pointer"
              >
                ✕
              </button>
            </div>
