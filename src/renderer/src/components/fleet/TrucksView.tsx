          ...
          trucks.map((truck) => (
            ...
            >
              ...
              <div className="absolute top-0 right-0 p-5 z-10">
                <span
                  className={`text-[9px] font-black px-2 py-1 rounded-md uppercase tracking-[0.2em] ring-1 w-max ${truck.type === 'Camión'
              ...
              <div className="flex items-center space-x-4 mb-6 relative z-10">
                <div className="w-16 h-16 rounded-full flex flex-col items-center justify-center transition-all duration-500 group-hover:scale-110 group-hover:-rotate-6 bg-orange-50 text-orange-600 ring-[6px] ring-white shadow-inner relative overflow-hidden shrink-0">
                  <div className="absolute inset-0 bg-gradient-to-br from-white/50 to-transparent pointer-events-none" />
                  <Truck size={24} className="relative z-10" />
                  {truck.is_refrigerated === 1 && (
                    <div className="absolute -bottom-1 -right-1 w-6 h-6 bg-blue-500 rounded-full border-2 border-white flex items-center justify-center shadow-sm" title="Unidad Refrigerada">
                      <span className="text-[10px] text-white font-bold">❄️</span>
                    </div>
                  )}
                </div>
                <div>
                  <h3 className="text-xl font-black text-slate-800 uppercase tracking-tighter shrink-0">
                    {truck.name}
                  </h3>
